...
class NewVisitorTest(LiveServerTestCase):
  ...
  def test_multiple_users_can_start_lists_at_different_urls(self):
    ...
    # Along comes a new user - Peter

    ## Using a new browser session we make sure that no information
    ## of Edith's list is coming through from Cookies, etc.
    self.browser.quit()
    self.browser = webdriver.Chrome()

    # Peter visits the home page. There is no sign of Edith's list
    ...
    # Peter starts a new list by entering a new item. He is less
    ...
    # Peter has his own unique url
    peter_list_url = self.browser.current_url
    self.assertRegex(peter_list_url, '/lists/.+')
    self.assertNotEqual(peter_list_url, edit_list_url)
