...
class NewVisitorTest(LiveServerTestCase):
  ...
  def check_for_row_in_a_list_table(self, row_text):
  ...
  def test_can_start_a_list_and_retrieve_it_later(self):
    ...
    self.check_for_row_in_a_list_table('1: Buy peacock feathers')
    self.check_for_row_in_a_list_table('2: Use peacock feathers to make a fly')
